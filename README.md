...
| 2 | Pipeline MLOps train → registry → deploy | [`mlops-pipeline/`](mlops-pipeline/) | CI/CD (GitHub Actions), JFrog, MLflow, Vertex AI Pipelines, K8s |
...
Python · Git/GitHub Actions · Docker · Kubernetes · Vault · JFrog · Grafana · Redis ·
...
- [`AGENTS.md`](AGENTS.md) — instructions pour les sessions OpenCode (commandes, conventions)
- [`DETTE-Technique.md`](DETTE-Technique.md) — inventaire de la dette technique
- [`CLAUDE.md`](CLAUDE.md) — instructions pour Claude Code
- [`.github/workflows/ci.yml`](.github/workflows/ci.yml) — CI GitHub Actions (lint → typecheck → test sur les 5 projets)
